...
"""
############################## SECTION TO CHANGE ###############################
DATABASE = '/riou/work/crise/takerkart/vodev_0.2_scripts/' # Database
DATA_BLK = '/riou/work/crise/takerkart/tethys_data_for_jarron/raw_unimported_data/vobi_one_raw_demo_data'
protocol='protocol_sc' # Protocol name
subject='subject_sc_sbin2' # Subject name
...
corner0=(60,125) # Top left-hand corner for parameters estimation
...
for cdt in blk_conditions_list:
    counter[cdt]=0
...
print('VISUALIZATION OF DATA GRAPHs')
