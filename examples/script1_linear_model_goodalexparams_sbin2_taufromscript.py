...
subject='subject_sc_tbin5_sbin2' # Subject name
session_date='080313' # Sesion date
analysis_name='_alexparams1_taufromscripts' # Analysis name
# Linear model parameters definition
param=(
    22.0, # Sampling frequency
    0.999, # Trial duration
    4.67, # Tau for dye bleaching
    '(1.58,10,28,41,50)', # Frequencies with heartbeat frequency in first
