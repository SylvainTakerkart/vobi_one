...
subject='subject_sc_tbin5' # Subject name
session_date='080313' # Sesion date
analysis_name='_1' # Analysis name
# Linear model parameters definition
param=(
    22.0, # Sampling frequency
    0.999, # Trial duration
    0.97, # Tau for dye bleaching
    '(1.89,10,28,41,50)', # Frequencies with heartbeat frequency in first
    '(2,1,1,1,1)', # Orders' frequencies
    10, # L = Number of main components used
    '(0.09,0.,0.03,0.45,0.06,0.,0.,0.)', # Alphas min
    '(0.15,0.,0.3,0.6,0.15,0.12,0.,0.)') # Alphas max
format='.nii'
################################################################################
