...
# The frame0 subtraction process. Substracts the first frames to the whole data

from neuroProcesses import *
from oi_formats import list_formats
import os

name = _t_('Frame0 Subtraction')
...
def initValuesf0( self , inp ):
    ...
    if self.data is not None:
        ...
        value['filename_variable']= os.path.splitext(os.path.splitext(os.path.basename( self.data.fullPath() ))[0])[0]+ '_f0s'
...
def execution( self,context ):
    ...
    self.validation()
    # The frame0 subtraction process. Substracts the first frames to the whole data
    oitrial_processes.frame0_subtraction_process(
